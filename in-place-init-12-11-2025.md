---
title: 'Thoughts on "out"-pointer, Nov 12 2025'
tags: [rust]
...
- Fn sig of constructor of a struct that delegates to other in-place initialisers? How to make transparent data like `UnsafeCell` play nice with its counterpart `&uninit UnsafeCell`?# Thoughts on "out"-pointer, Nov 12 2025
